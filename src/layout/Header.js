            ...
            <nav>
                <ul className="nav-list">
                    ...
                    <li className='dropdown'>
                        <Link to="/ihum-project/exhibit" className='nav-item'>Exhibit</Link>
                        <div className="dropdown-content" onMouseLeave={handleMouseOut}>

                            {/* Late Medieval */}
                            <Link to={`/ihum-project/exhibit/${lm}`} className='parent' style={{textAlign: 'left', backgroundColor: '#ccc', fontWeight: isSubMenuVisibleLM ? 'bold' : ''}} onMouseOver={handleMouseOverLM}>
                                {data["late-medieval"][0].name}
                            </Link>
                            <div className='child' style={{display: isSubMenuVisibleLM ? 'block' : 'none'}}>
                                <Link style={{borderBottom: 'solid grey 1px'}} to={`/ihum-project/exhibit/${lm}/the-last-judgement`}>
                            ...
                            {/* Early Renaissance */}
                            <Link to={`/ihum-project/exhibit/${er}`} style={{textAlign: 'left', backgroundColor: '#ccc', fontWeight: isSubMenuVisibleER ? 'bold' : ''}} onMouseOver={handleMouseOverER}>
                                {data["early-renaissance"][0].name}
                            </Link>
                            <div className='child' style={{display: isSubMenuVisibleER ? 'block' : 'none'}}>
                                <Link style={{borderBottom: 'solid grey 1px'}} to={`/ihum-project/exhibit/${er}/the-holy-trinity`}>
                                ...
                                <Link style={{borderBottom: 'solid grey 1px'}} to={`/ihum-project/exhibit/${er}/self-portrait`}>
                            ...
                            {/* Early-mid Renaissance */}
                            <Link to={`/ihum-project/exhibit/${emr}`} style={{textAlign: 'left', backgroundColor: '#ccc', fontWeight: isSubMenuVisibleEMR ? 'bold' : ''}} onMouseOver={handleMouseOverEMR}>
                                {data["early-mid-renaissance"][0].name}
                            </Link>
                            <div className='child' style={{display: isSubMenuVisibleEMR ? 'block' : 'none'}}>
                                <Link style={{borderBottom: 'solid grey 1px'}} to={`/ihum-project/exhibit/${emr}/the-birth-of-venus`}>
                            ...
                            {/* Mid Renaissance */}
                            <Link to={`/ihum-project/exhibit/${mr}`} style={{textAlign: 'left', backgroundColor: '#ccc', fontWeight: isSubMenuVisibleMR ? 'bold' : ''}} onMouseOver={handleMouseOverMR}>
                                {data["mid-renaissance"][0].name}
                            </Link>
                            <div className='child' style={{display: isSubMenuVisibleMR ? 'block' : 'none'}}>
                                <Link style={{borderBottom: 'solid grey 1px'}} to={`/ihum-project/exhibit/${mr}/vitruvian-man`}>
                                ...
                                <Link style={{borderBottom: 'solid grey 1px'}} to={`/ihum-project/exhibit/${mr}/the-school-of-athens`}>
                            ...
                            {/* High Renaissance */}
                            <Link to={`/ihum-project/exhibit/${hr}`} style={{textAlign: 'left', backgroundColor: '#ccc', fontWeight: isSubMenuVisibleHR ? 'bold' : ''}} onMouseOver={handleMouseOverHR}>
                                {data["high-renaissance"][0].name}
                            </Link>
                            <div className='child' style={{display: isSubMenuVisibleHR ? 'block' : 'none'}}>
                                <Link style={{borderBottom: 'solid grey 1px'}} to={`/ihum-project/exhibit/${hr}/assumption-of-the-virgin`}>
                                ...
                                <Link style={{borderBottom: 'solid grey 1px'}} to={`/ihum-project/exhibit/${hr}/mona-lisa`}>
                            ...
                            {/* Late Renaissance */}
                            <Link to={`/ihum-project/exhibit/${lr}`} style={{textAlign: 'left', backgroundColor: '#ccc', fontWeight: isSubMenuVisibleLR ? 'bold' : ''}} onMouseOver={handleMouseOverLR}>
                                {data["late-renaissance"][0].name}
                            </Link>
                            <div className='child' style={{display: isSubMenuVisibleLR ? 'block' : 'none'}}>
                                <Link style={{borderBottom: 'solid grey 1px'}} to={`/ihum-project/exhibit/${lr}/bacchus-and-ariadne`}>
                                ...
                                <Link style={{borderBottom: 'solid grey 1px'}} to={`/ihum-project/exhibit/${lr}/the-harvesters`}>
                                ...
                                <Link style={{borderBottom: 'solid grey 1px'}} to={`/ihum-project/exhibit/${lr}/the-calling-of-saint-matthew`}>
